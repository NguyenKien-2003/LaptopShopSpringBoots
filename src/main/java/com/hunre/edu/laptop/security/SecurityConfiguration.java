package com.hunre.edu.laptop.security;

import com.hunre.edu.laptop.security.jwt.JwtFilter;
import com.hunre.edu.laptop.services.UserService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.authorizeHttpRequests(
                config->config
                        ...
                        .requestMatchers(HttpMethod.PUT, Endpoints.STAFF_PUT_ENDPOINTS).hasAnyAuthority("STAFF", "ADMIN")
                        .requestMatchers(HttpMethod.GET, Endpoints.STAFF_GET_ENDPOINTS).hasAnyAuthority("STAFF", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, Endpoints.STAFF_POST_ENDPOINTS).hasAnyAuthority("STAFF", "ADMIN")
